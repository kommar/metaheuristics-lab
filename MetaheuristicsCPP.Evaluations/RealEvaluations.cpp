...
CRealSphere10Evaluation::CRealSphere10Evaluation(int iSize)
	: CProxyEvaluation<double, double>(&pc_vertical_scaling_evaluation)
{
...
CRealEllipsoidEvaluation::CRealEllipsoidEvaluation(int iSize)
	: CProxyEvaluation<double, double>(&pc_horizontal_scaling_evaluation)
{
	pc_sphere_evaluation = new CRealSphereEvaluation(iSize);
...
CRealStep2SphereEvaluation::CRealStep2SphereEvaluation(int iSize)
	: CProxyEvaluation<double, double>(&pc_step_evaluation)
{
...
CRealCEC2013MultimodalEvaluation::CRealCEC2013MultimodalEvaluation(ERealCEC2013MultimodalInstance eInstance)
	: CRealCEC2013MultimodalEvaluation(CEC2013((int)eInstance), eInstance)
{

}//CRealCEC2013MultimodalEvaluation::CRealCEC2013MultimodalEvaluation(ERealCEC2013MultimodalInstance eInstance)

double CRealCEC2013MultimodalEvaluation::t_evaluate(vector<double> &vSolution)
{
	return (double)c_cec2013.evaluate(vSolution.data());
}//double CRealCEC2013MultimodalEvaluation::t_evaluate(vector<double> &vSolution)

CRealCEC2013MultimodalEvaluation::CRealCEC2013MultimodalEvaluation(CEC2013 &&cCEC2013, ERealCEC2013MultimodalInstance eInstance)
	: CRealEvaluation(cCEC2013.get_dimension(), cCEC2013.get_fitness_goptima(), cCEC2013.get_lbound(0), cCEC2013.get_ubound(0)), c_cec2013((int)eInstance)
{
