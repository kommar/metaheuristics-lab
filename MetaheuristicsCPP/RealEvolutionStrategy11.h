...
{
	class CRealEvolutionStrategy11 : public COptimizer<double, double, CSingleObjectiveOptimizationResult<double>>
	{
	public:
		CRealEvolutionStrategy11(IEvaluation<double, double> &cEvaluation, IStopCondition &cStopCondition, IRealMutationES11Adaptation &cMutationAdaptation, mt19937 &cRandomEngine);
