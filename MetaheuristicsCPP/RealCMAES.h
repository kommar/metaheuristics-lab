...
namespace Optimizers
{
	...
	{
	public:
		CCMAESIndividual(IEvaluation<double, double> &cEvaluation, VectorXd &vSample);
	...
	private:
		...
		IEvaluation<double, double> &c_evaluation;
	};//class CCMAESIndividual


	class CRealCMAES : public COptimizer<double, double, CSingleObjectiveOptimizationResult<double>>
	{
	public:
		CRealCMAES(IEvaluation<double, double> &cEvaluation, IStopCondition &cStopCondition, mt19937 &cRandomEngine, double dInitSigma);
	...
	private:
		...
		bool b_update_state(CCMAESIndividual &cIndividual);
