...
CRealEvolutionStrategy11::CRealEvolutionStrategy11(IEvaluation<double, double> &cEvaluation, IStopCondition &cStopCondition, IRealMutationES11Adaptation &cMutationAdaptation, mt19937 &cRandomEngine)
	: COptimizer<double, double, CSingleObjectiveOptimizationResult<double>>(cEvaluation, cStopCondition, new CSingleObjectiveOptimizationState<double>(cEvaluation.tGetMaxValue())), c_mutation_adaptation(cMutationAdaptation), c_random_engine(cRandomEngine)
{
...
void CRealEvolutionStrategy11::v_initialize(clock_t tStartTime)
{
	...
	b_update_state(v_initial_solution, c_evaluation.tEvaluate(v_initial_solution));
}//void CRealEvolutionStrategy11::v_initialize(clock_t tStartTime)
...
bool CRealEvolutionStrategy11::b_run_iteration(long long iIterationNumber, clock_t tStartTime)
{
	...
	double d_candidate_value = c_evaluation.tEvaluate(v_candidate_solution);
	...
	return b_update_state(v_candidate_solution, d_candidate_value);
}//bool CRealEvolutionStrategy11::b_run_iteration(long long iIterationNumber, clock_t tStartTime)