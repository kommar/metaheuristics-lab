...
namespace Optimizers.SingleObjective.CMAESImpl
{
    class Individual
    {
        private readonly IEvaluation<double, double> evaluation;

        public double Fitness { get; private set; }
        public List<double> Genotype { get; private set; }

        public Individual(IEvaluation<double, double> evaluation, Vector<double> sample)
        {
