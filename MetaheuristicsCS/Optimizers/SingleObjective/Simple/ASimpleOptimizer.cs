...
namespace Optimizers.Simple
{
    ...
    sealed class ASimpleOptimizer<Element>
    {
        ...
        private IEvaluation<Element, double> evaluation;
        ...
        private bool CheckNewBest(List<Element> solution, double value, bool onlyImprovements = true)
        {
            ...
            {
                Result = new OptimizationResult<Element>(solution, value, iterationNumber, evaluation.iFFE, TimeUtils.DurationInSeconds(startTime));
